...
export const defaultContent: Content = {
  ...
  projects: [
    ...
    {
      name: "Drone Project",
      people: [{ name: "Jason Zhang" }, { name: "Gavin Lesko" }],
  ...
  leadership: [
    { name: "Jason Zhang", position: "President", projects: ["Drone Project"] },
    {
      name: "Sydney Simmons",
    ...
    { name: "Zane Brotherton", position: "Treasurer", projects: ["IGVC"] },
    { name: "Kateri Ngo", position: "Secretary", projects: ["Paper Club"] },
    {
      name: "Gavin Lesko",
      position: "Outreach Coordinator",
      projects: ["Drone Project"],
    },
    { name: "Hana Mali", position: "Social Media Manager" },
    { name: "Zach Nobles", position: "Safety Officer" },
    { name: "Aidan Zitron", position: "General Representative" },
    { name: "Hayden Heroux", position: "General Representative" },
    { name: "Jerry Norton", position: "General Representative" },
    { name: "Cyle Rush", position: "Team Lead", projects: ["Combat Robotics"] },
    {
      name: "Jayden Smith",
      email: "smithj@rpi.edu",
      position: "Team Lead",
